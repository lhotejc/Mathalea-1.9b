...
import {liste_de_question_to_contenu,randint,shuffle,combinaison_listes,calcul,creerNomDePolygone,lettre_depuis_chiffre,nombre_avec_espace} from "/modules/outils.js"
import {point,pointIntersectionDD,pointAdistance,labelPoint,droite,droiteParPointEtPerpendiculaire,segmentAvecExtremites,polygoneAvecNom,cercle,pointIntersectionLC,pointIntersectionCC,traceCompas,dansLaCibleRonde,cibleRonde,rotation,similitude,codageAngleDroit,afficheLongueurSegment,afficheMesureAngle,codeAngle,texteParPoint,angle,mathalea2d} from "/modules/2d.js"
/**
 * publié le 1/12/2020
