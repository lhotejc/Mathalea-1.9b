...
Exercice.call(this); // Héritage de la classe Exercice()
   ...
   // this.sup = 1 ; // 
    ...
    for (let i = 0, a,ux,uy,xA,yA,xB,yB,xC,yC,xD,yD,AB,XAB,YAB,XAC,YAC,XBC,YBC,AC,BC,XAD,YAD,AD,xI0,xI1,yI0,yI1,xJ0,xJ1,yJ0,yJ1, texte, texte_corr, cpt=0; i < this.nb_questions && cpt<50; ) 
    {
    ...
    switch (type_de_questions){
                ...
                case 1 : 
                   ...
                   AC=XAC+YAC;
                    ...
                    if (AB%100==0 && AB!=100)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=10\\sqrt{${tex_nombre((AB))/100}}$<br>`}
                    if (AB%81==0 && AB!=81)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=9\\sqrt{${tex_nombre((AB))/81}}$<br>`}
                    if (AB%64==0 && AB!=64)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=8\\sqrt{${tex_nombre((AB))/64}}$<br>`}
                    if (AB%49==0 && AB!=49)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=7\\sqrt{${tex_nombre((AB))/49}}$<br>`}
                     if (AB%36==0&& AB!=36)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=6\\sqrt{${tex_nombre((AB))/36}}$<br>`}
                     if (AB%25==0 && AB!=25)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=5\\sqrt{${tex_nombre((AB))/25}}$<br>`}
                     if (AB%64!=0 && AB%16==0&& AB!=16)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=4\\sqrt{${tex_nombre((AB))/16}}$<br>`}
                    if (AB%81!=0 && AB%9==0 && AB!=9)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=3\\sqrt{${tex_nombre((AB))/9}}$<br>`}
                    if (AB%16!=0 && AB%64!==0 &&AB%4==0 && AB!=4)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=2\\sqrt{${tex_nombre((AB))/4}}$<br>`}
                      if (AB==100)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=10$<br>`}
                    if (AB==81)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=9$<br>`}
                      if (AB==64)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=8$<br>`}
                      if (AB==49)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=7$<br>`}
                      if (AB==36)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=6$<br>`}
                      if (AB==25)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=5$<br>`}
                      if (AB==16)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=4$<br>`}
                      if (AB==9)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=3$<br>`}
                      if (AB==4)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=2$<br>`}
                      if (AB==1)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AB=1$<br>`}
                    ...
                    if (AC%100==0 && AC!=100)
                        { texte_corr +=`$\\phantom{De meme :  } AC=10\\sqrt{${tex_nombre((AC))/100}}$<br>`}
                    if (AC%81==0 && AC!=81)
                        { texte_corr +=`$\\phantom{De meme :  } AC=9\\sqrt{${tex_nombre((AC))/81}}$<br>`}
                    if (AC%64==0 && AC!=64)
                        { texte_corr +=`$\\phantom{De meme :  } AC=8\\sqrt{${tex_nombre((AC))/64}}$<br>`}
                    if (AC%49==0 && AC!=49)
                        { texte_corr +=`$\\phantom{De meme :  } AC=7\\sqrt{${tex_nombre((AC))/49}}$<br>`}
                     if (AC%36==0&& AC!=36)
                        { texte_corr +=`$\\phantom{De meme :  } AC=6\\sqrt{${tex_nombre((AC))/36}}$<br>`}
                     if (AC%25==0 && AC!=25)
                        { texte_corr +=`$\\phantom{De meme :  } AC=5\\sqrt{${tex_nombre((AC))/25}}$<br>`}
                     if (AC%64!=0 && AC%16==0&& AC!=16)
                        { texte_corr +=`$\\phantom{De meme :  } AC=4\\sqrt{${tex_nombre((AC))/16}}$<br>`}
                    if (AC%81!=0 && AC%9==0 && AC!=9)
                        { texte_corr +=`$\\phantom{De meme :  } AC=3\\sqrt{${tex_nombre((AC))/9}}$<br>`}
                    if (AC%16!=0 && AC%64!==0 &&AC%4==0 && AC!=4)
                        { texte_corr +=`$\\phantom{De meme :  } AC=2\\sqrt{${tex_nombre((AC))/4}}$<br>`}
                      if (AC==100)
                        { texte_corr +=`$\\phantom{De meme :  } AC=10$<br>`}
                    if (AC==81)
                        { texte_corr +=`$\\phantom{De meme :  } AC=9$<br>`}
                      if (AC==64)
                        { texte_corr +=`$\\phantom{De meme :  } AC=8$<br>`}
                      if (AC==49)
                        { texte_corr +=`$\\phantom{De meme :  } AC=7$<br>`}
                      if (AC==36)
                        { texte_corr +=`$\\phantom{De meme :  } AC=6$<br>`}
                      if (AC==25)
                        { texte_corr +=`$\\phantom{De meme :  } AC=5$<br>`}
                      if (AC==16)
                        { texte_corr +=`$\\phantom{De meme :  } AC=4$<br>`}
                      if (AC==9)
                        { texte_corr +=`$\\phantom{De meme :  } AC=3$<br>`}
                      if (AC==4)
                        { texte_corr +=`$\\phantom{De meme :  } AC=2$<br>`}
                      if (AC==1)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=1$<br>`}
            ...
            case 3:
                   ...
                   texte_corr +=`<br> Les coordonnées du point $J$ milieu de $[BC]$ sont `
                    ...
                    if (AC%100==0 && AC!=100)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=10\\sqrt{${tex_nombre((AC))/100}}$<br>`}
                    if (AC%81==0 && AC!=81)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=9\\sqrt{${tex_nombre((AC))/81}}$<br>`}
                    if (AC%64==0 && AC!=64)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=8\\sqrt{${tex_nombre((AC))/64}}$<br>`}
                    if (AC%49==0 && AC!=49)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=7\\sqrt{${tex_nombre((AC))/49}}$<br>`}
                     if (AC%36==0&& AC!=36)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=6\\sqrt{${tex_nombre((AC))/36}}$<br>`}
                     if (AC%25==0 && AC!=25)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=5\\sqrt{${tex_nombre((AC))/25}}$<br>`}
                     if (AC%64!=0 && AC%16==0&& AC!=16)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=4\\sqrt{${tex_nombre((AC))/16}}$<br>`}
                    if (AC%81!=0 && AC%9==0 && AC!=9)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=3\\sqrt{${tex_nombre((AC))/9}}$<br>`}
                    if (AC%16!=0 && AC%64!==0 &&AC%4==0 && AC!=4)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=2\\sqrt{${tex_nombre((AC))/4}}$<br>`}
                      if (AC==100)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=10$<br>`}
                    if (AC==81)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=9$<br>`}
                      if (AC==64)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=8$<br>`}
                      if (AC==49)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=7$<br>`}
                      if (AC==36)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=6$<br>`}
                      if (AC==25)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=5$<br>`}
                      if (AC==16)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=4$<br>`}
                      if (AC==9)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=3$<br>`}
                      if (AC==4)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=2$<br>`}
                     if (AD==1)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AC=1$<br>`}
               ...
               break;
                case 4:
                   ...
                   texte_corr +=`<br> Les coordonnées du point $J$ milieu de $[BC]$ sont `
                    ...
                    if (AD%100==0 && AD!=100)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=10\\sqrt{${tex_nombre((AD))/100}}$<br>`}
                    if (AD%81==0 && AD!=81)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=9\\sqrt{${tex_nombre((AD))/81}}$<br>`}
                    if (AD%64==0 && AD!=64)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=8\\sqrt{${tex_nombre((AD))/64}}$<br>`}
                    if (AD%49==0 && AD!=49)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=7\\sqrt{${tex_nombre((AD))/49}}$<br>`}
                     if (AD%36==0&& AD!=36)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=6\\sqrt{${tex_nombre((AD))/36}}$<br>`}
                     if (AD%25==0 && AD!=25)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=5\\sqrt{${tex_nombre((AD))/25}}$<br>`}
                     if (AD%64!=0 && AD%16==0&& AD!=16)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=4\\sqrt{${tex_nombre((AD))/16}}$<br>`}
                    if (AD%81!=0 && AD%9==0 && AD!=9)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=3\\sqrt{${tex_nombre((AD))/9}}$<br>`}
                    if (AD%16!=0 && AD%64!==0 &&AD%4==0 && AD!=4)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=2\\sqrt{${tex_nombre((AD))/4}}$<br>`}
                      if (AD==100)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=10$<br>`}
                    if (AD==81)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=9$<br>`}
                      if (AD==64)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=8$<br>`}
                      if (AD==49)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=7$<br>`}
                      if (AD==36)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=6$<br>`}
                      if (AD==25)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=5$<br>`}
                      if (AD==16)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=4$<br>`}
                      if (AD==9)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=3$<br>`}
                      if (AD==4)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=2$<br>`}
                     if (AD==1)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } AD=1$<br>`}
                    ...
                    if (BC%100==0 && BC!=100)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=10\\sqrt{${tex_nombre((BC))/100}}$<br>`}
                    if (BC%81==0 && BC!=81)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=9\\sqrt{${tex_nombre((BC))/81}}$<br>`}
                    if (BC%64==0 && BC!=64)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=8\\sqrt{${tex_nombre((BC))/64}}$<br>`}
                    if (BC%49==0 && BC!=49)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=7\\sqrt{${tex_nombre((BC))/49}}$<br>`}
                     if (BC%36==0&& BC!=36)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=6\\sqrt{${tex_nombre((BC))/36}}$<br>`}
                     if (BC%25==0 && BC!=25)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=5\\sqrt{${tex_nombre((BC))/25}}$<br>`}
                     if (BC%64!=0 && BC%16==0&& BC!=16)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=4\\sqrt{${tex_nombre((BC))/16}}$<br>`}
                    if (BC%81!=0 && BC%9==0 && BC!=9)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=3\\sqrt{${tex_nombre((BC))/9}}$<br>`}
                    if (BC%16!=0 && BC%64!==0 &&BC%4==0 && BC!=4)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=2\\sqrt{${tex_nombre((BC))/4}}$<br>`}
                      if (BC==100)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=10$<br>`}
                    if (BC==81)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=9$<br>`}
                      if (BC==64)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=8$<br>`}
                      if (BC==49)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=7$<br>`}
                      if (BC==36)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=6$<br>`}
                      if (BC==25)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=5$<br>`}
                      if (BC==16)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=4$<br>`}
                      if (BC==9)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=3$<br>`}
                      if (BC==4)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=2$<br>`}
                     if (BC==1)
                        { texte_corr +=`$\\phantom{On applique la relation a l'enonce :   } BC=1$<br>`}
             ...
             case 5:
                   ...
                   texte_corr +=`<br> Les coordonnées du point $J$ milieu de $[BC]$ sont `
                    ...
                    if (AB%100==0 && AB!=100)
                        { texte_corr +=`$AB =10\\sqrt{${tex_nombre((AB))/100}}$<br>`}
                    if (AB%81==0 && AB!=81)
                        { texte_corr +=`$AB =9\\sqrt{${tex_nombre((AB))/81}}$<br>`}
                    if (AB%64==0 && AB!=64)
                        { texte_corr +=`$AB  =8\\sqrt{${tex_nombre((AB))/64}}$<br>`}
                    if (AB%49==0 && AB!=49)
                        { texte_corr +=`$AB  =7\\sqrt{${tex_nombre((AB))/49}}$<br>`}
                     if (AB%36==0&& AB!=36)
                        { texte_corr +=`$AB  =6\\sqrt{${tex_nombre((AB))/36}}$<br>`}
                     if (AB%25==0 && AB!=25)
                        { texte_corr +=`$AB  =5\\sqrt{${tex_nombre((AB))/25}}$<br>`}
                     if (AB%64!=0 && AB%16==0&& AB!=16)
                        { texte_corr +=`$AB  =4\\sqrt{${tex_nombre((AB))/16}}$<br>`}
                    if (AB%81!=0 && AB%9==0 && AB!=9)
                        { texte_corr +=`$AB =3\\sqrt{${tex_nombre((AB))/9}}$<br>`}
                    if (AB%16!=0 && AB%64!==0 &&AB%4==0 && AB!=4)
                        { texte_corr +=`$AB =2\\sqrt{${tex_nombre((AB))/4}}$<br>`}
                      if (AB==100)
                        { texte_corr +=`$AB =10$<br>`}
                    if (AB==81)
                        { texte_corr +=`$AB =9$<br>`}
