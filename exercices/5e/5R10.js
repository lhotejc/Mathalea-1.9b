...
import {liste_de_question_to_contenu,randint,ecriture_parenthese_si_moins,tex_nombrec,arrondi} from "/modules/outils.js"
...
export default function Terme_inconnu_de_somme() {
  ...
  this.nouvelle_version = function () {
    ...
    for (let i = 0, a, b, texte, texte_corr; i < this.nb_questions; i++) {
      ...
      texte = `$${a} + \\ldots\\ldots = ${b}$`;
      texte_corr = `$${a} + ${ecriture_parenthese_si_moins(tex_nombrec( b-a))} = ${b}$`;
      texte_corr +=`. En effet : $${b}-${a}=${b-a}$`
      if (est_diaporama) {
