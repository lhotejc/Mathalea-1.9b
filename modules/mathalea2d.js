...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
*/
import {egal,randint,rangeMinMax,unSiPositifMoinsUnSinon,arrondi,arrondi_virgule,calcul,tex_nombre,nombre_avec_espace,string_nombre,premierMultipleSuperieur,premierMultipleInferieur} from "/modules/outils.js"
 ...
 * @Auteur Jean-Claude Lhote
 */
export function Droite(arg1, arg2, arg3, arg4) {
  ObjetMathalea2D.call(this);
 ...
 * @Auteur Rémi Angot
 */
export function ConstructionMediatrice(
  A,
  B,
  detail = false,
  color = "blue",
 ...
 * @Auteur Jean-Claude Lhote
 */
export function CodageBissectrice(A, O, B, color = "black", mark = "×") {
  ObjetMathalea2D.call(this);
  this.color = color;
  this.mark=mark
  this.centre=O
 ...
 * @Auteur Rémi Angot
 */
export function ConstructionBissectrice(
  A,
  O,
  B,
  detail = false,
 ...
 * @Auteur Rémi Angot
 */
export function Segment(arg1, arg2, arg3, arg4, color) {
  ObjetMathalea2D.call(this);
 ...
 * @Auteur Jean-Claude Lhote
 */
export function NommePolygone(p, nom = "", k = 0.5) {
  ObjetMathalea2D.call(this);
  this.poly=p
  this.dist=k
 ...
 * @Auteur Rémi Angot
 */
export function Cercle(O, r, color) {
  ObjetMathalea2D.call(this);
  if (color) {
    this.color = color;
 ...
 * @Auteur Rémi Angot
 */
export function CercleCentrePoint(O, M, color = "black") {
 ...
 * @Auteur Jean-Claude Lhote
 */
export function ArcPointPointAngle(M,N,angle,rayon=false,fill='none',color='black',fillOpacite=0.2) {
...
export function CourbeDeBezier(A, B, C) {
  ObjetMathalea2D.call(this);
  this.svg = function (coeff) {
 ...
 * @Auteur Jean-Claude Lhote
 */
export function SegmentMainLevee(A,B,amp,color='black') {
  ObjetMathalea2D.call(this);
  this.svg = function (coeff) {
    if (this.epaisseur != 1) {
      this.style += ` stroke-width="${this.epaisseur}" `;
 ...
 * @Auteur Jean-Claude Lhote
 */
export function CercleMainLevee(A,r,amp,color='black') {
  ObjetMathalea2D.call(this);
  this.color=color;
  this.svg = function (coeff) {
    if (this.epaisseur != 1) {
 ...
 * @Auteur Jean-Claude Lhote
 */
export function DroiteMainLevee(A,B,amp,color='black'){
  ObjetMathalea2D.call(this)
  this.svg = function(coeff) {
 ...
 * @Auteur Jean-Claude Lhote
 */
export function PolygoneMainLevee(points,amp) {
    ObjetMathalea2D.call(this);
    this.couleurDeRemplissage = "";
    this.opaciteDeRemplissage = 0.7;
...
export function CodageMedianeTriangle(B, C, color = "black", mark = "//") {
  ObjetMathalea2D.call(this);
  this.color = color;
  let O = milieu(B, C);
 ...
 * @Auteur Rémi Angot
 */
export function AfficheLongueurSegment(A, B, color = "black", d = 0.5) {
  ObjetMathalea2D.call(this);
  this.color = color;
  this.extremite1=A
  this.extremite2=B
 ...
 * @Auteur Rémi Angot
 */
export function TexteSurSegment(texte, A, B, color = "black", d = 0.5) {
  ObjetMathalea2D.call(this);
  this.color = color;
  this.extremite1=A
  this.extremite2=B
 ...
 * @Auteur Rémi Angot
 */
export function CodeSegment(A, B, mark = "||", color = "black") {
  ObjetMathalea2D.call(this);
  this.color = color;
  let O = milieu(A, B);
  let s = segment(A, B);
 ...
 */
export function DroiteGraduee(x=0,y=0,position='H',type='dd',longueurUnite=10,division=10,longueurTotale=15,origin=0,unite=1,labelGauche='O',labelUnite='I',gradue=true,...args){
  ObjetMathalea2D.call(this);
 ...
 */
 ...
 export function DroiteGraduee2({
 ...
 * @Auteur Rémi Angot
 */
export function GrilleHorizontale(
  xmin = -30,
  ymin = -30,
  xmax = 30,
  ymax = 30,
...
export function Seyes(xmin = 0, ymin = 0, xmax = 15, ymax = 15,opacite1 = .5, opacite2 = .2) {
  ObjetMathalea2D.call(this)
  objets = [];
 ...
 * @auteur Rémi Angot
 */
export function TraceBarre(x,y,legende='',{epaisseur=.6,couleurDeRemplissage='blue',color='black',opaciteDeRemplissage=.3,angle=66,unite=1}={}){
  ObjetMathalea2D.call(this)
 ...
 * @auteur Rémi Angot
 */
export function TraceBarreHorizontale(x,y,legende='',{epaisseur=.6,couleurDeRemplissage='blue',color='black',opaciteDeRemplissage=.3,unite=1}={}){
  ObjetMathalea2D.call(this)
...
export function LectureImage(x,y,xscale=1,yscale=1,color='red',text_abs="",text_ord=""){
  ObjetMathalea2D.call(this)
  this.x=x
  this.y=y
  this.xscale=xscale
...
export function LectureAntecedent(x,y,xscale,yscale,color,text_ord,text_abs){
  "use strict"
  ObjetMathalea2D.call(this)
  this.x=x
  this.y=y
 ...
 * @Auteur Rémi Angot
 */
export function TexteParPoint(texte, A, orientation = "milieu", color='black',scale=1,ancrageDeRotation = "middle",math_on=false) {
  ObjetMathalea2D.call(this);
  this.color = color;
  this.svg = function (coeff) {
    let code = "";
 ...
 * @Auteur Rémi Angot
 */
export function LatexParPoint(texte, A, color) {
  ObjetMathalea2D.call(this);
  this.color = color;
  this.svg = function (coeff) {
...
export function FractionParPosition({x=0,y=0,num=1,den=2,couleur='black'}){
  ObjetMathalea2D.call(this);
...
export function Print2d(helloworld){
 ...
 * 
 */
export function TranslationInstrument(instrument,A,B,begin=0,id){
  ObjetMathalea2D.call(this)
...
export function translationInstrument(...args){
 ...
 * @Auteur Rémi Angot
 */
export function codeSvg(...objets) {
  let code = "";
 ...
 * @Auteur Rémi Angot
 */
export function codeTikz(...objets) {
  let code = "";
  let fenetrexmin = fenetreMathalea2d[0]
  let fenetreymin = fenetreMathalea2d[3]*-(1) 
  let fenetrexmax = fenetreMathalea2d[2]
